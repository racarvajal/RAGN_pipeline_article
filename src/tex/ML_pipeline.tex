...
\begin{figure}
  ...
  \begin{minipage}{0.29\textwidth}
    \centering
    %\input{|python ../scripts/fig_flowchart_HETDEX.py}
    \includegraphics[width=0.99\textwidth]{figures/flowchart_HETDEX_subsets.pdf}\\
    {(a) HETDEX Field}
  \end{minipage}
  \hfill 
  \begin{minipage}{0.19\textwidth}
    \centering
    %\input{|python ../scripts/fig_flowchart_Stripe82.py}
...
\begin{figure}
  ...
  \begin{minipage}{0.49\columnwidth}
    \centering
    \script{fig_conf_matrix_AGN_gal_validation.py}
    \includegraphics[width=0.97\textwidth]{figures/conf_matrix_AGN_HETDEX_validation.pdf}\\
    {(a) AGN-galaxy classification}
  \end{minipage}%\\%
  \begin{minipage}{0.49\columnwidth}
    \centering
    \script{fig_conf_matrix_radio_validation.py}
    \includegraphics[width=0.95\textwidth]{figures/conf_matrix_radio_HETDEX_validation.pdf}\\
    {(b) Radio detection on AGN}
  \end{minipage}\\%
  \begin{minipage}{0.65\columnwidth}
    \centering
    \script{fig_redshift_compare_validation.py}
    \includegraphics[width=0.9\textwidth]{figures/compare_redshift_HETDEX_validation.pdf}\\
...
\begin{figure*}
  ...
  \begin{minipage}{0.20\textwidth}
    \centering
    \script{fig_conf_matrix_radio_AGN_validation.py}
    \includegraphics[width=0.99\textwidth]{figures/conf_matrix_rAGN_HETDEX_validation.pdf}\\
    {(a) Radio-AGN confusion matrix}
  \end{minipage}%\\%
      \centering
  \begin{minipage}{0.30\textwidth}
    \centering
    \script{fig_redshift_compare_rAGN_validation.py}
    \includegraphics[width=0.99\textwidth]{figures/compare_redshift_rAGN_HETDEX_validation.pdf}\\
    {(b) Predicted-True $z$ comparison}
  \end{minipage}%\\%
  \begin{minipage}{0.20\textwidth}
    \centering
    \script{fig_conf_matrix_radio_AGN_Stripe_82.py}
    \includegraphics[width=0.99\textwidth]{figures/conf_matrix_rAGN_Stripe82.pdf}\\
    {(c) Radio-AGN confusion matrix}
  \end{minipage}%\\%
  \begin{minipage}{0.30\textwidth}
    \centering
    \script{fig_redshift_compare_rAGN_Stripe_82.py}
    \includegraphics[width=0.99\textwidth]{figures/compare_redshift_rAGN_Stripe82.pdf}\\
...
\begin{figure}
  ...
  \begin{minipage}{0.23\textwidth}
    \centering
    \script{fig_calibration_AGN_gal_pre.py}
    \includegraphics[width=0.99\textwidth]{figures/calib_curves_pre_calib_AGN_galaxy.pdf}\\
    {(a) AGN-galaxy}
  \end{minipage}
  \hfill 
  \begin{minipage}{0.23\textwidth}
    \centering
    \script{fig_calibration_radio_pre.py}
    \includegraphics[width=0.99\textwidth]{figures/calib_curves_pre_calib_radio.pdf}\\
    {(b) Radio detection}
  \end{minipage}
...
\begin{figure}
  ...
  \begin{minipage}{0.23\textwidth}
    \centering
    \script{fig_calibration_AGN_gal_post.py}
    \includegraphics[width=0.99\textwidth]{figures/calib_curves_post_calib_AGN_galaxy.pdf}\\
    {(a) AGN-galaxy}
  \end{minipage}
  \hfill 
  \begin{minipage}{0.23\textwidth}
    \centering
    \script{fig_calibration_radio_post.py}
    \includegraphics[width=0.99\textwidth]{figures/calib_curves_post_calib_radio.pdf}\\
    {(b) Radio detection}
  \end{minipage}
...
\begin{figure}
  ...
  \begin{minipage}{0.23\textwidth}
    \centering
    \script{fig_PR_curve_AGN_gal.py}
    \includegraphics[width=0.98\textwidth]{figures/PR_cal_curve_AGN_gal.pdf}
    %{(a) AGN-galaxy} 
  \end{minipage}
  \hfill 
  \begin{minipage}{0.23\textwidth}
    \centering
    \script{fig_PR_curve_radio.py}
    \includegraphics[width=0.98\textwidth]{figures/PR_cal_curve_radio.pdf}
    %{(b) Radio detection}
  \end{minipage}
  \centering
  \caption{Precision-Recall curves for the AGN-Galaxy  (Left) and radio detection (Right) classification models.}
