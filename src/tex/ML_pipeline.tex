...
\hline
\multirow{2}{*}{\textbf{HETDEX-test}} & Naive     & 0.9537      & 0.9181  & 0.9747    & 0.9589 \\
                                  & PR        & 0.9542      & 0.9185  & 0.9449    & 0.9621 \\
\multirow{2}{*}{\textbf{S82-labelled}}  & Naive     & 0.9415      & 0.7054  & 0.9516    & 0.9333 \\
...
Subset                             & Threshold & F$_{\beta}$ & MCC  & Precision & Recall  \\
\hline
\multirow{2}{*}{\textbf{HETDEX-test}} & Naive     & 0.2487    & 0.2736 & 0.6061   & 0.1672  \\
                                    & PR        & 0.4288    & 0.3247 & 0.3528   & 0.5216  \\
\multirow{2}{*}{\textbf{S82-labelled}}  & Naive     & 0.2715    & 0.2336 & 0.2572   & 0.2847  \\
...
\hline
\textbf{HETDEX-test}    & 0.1654    & 0.0727     & 0.4114  & 0.2056       & 0.1903 \\
\textbf{S82-labelled}   & 0.1866    & 0.0928     & 0.5108  & 0.2469       & 0.2429 \\
...
Subset                                  & Threshold & F$_{\beta}$ & MCC      & Precision  & Recall    \\
\hline
\multirow{2}{*}{HETDEX-\textbf{test}}   & Naive     & 0.2068    & 0.2493    & 0.5234    & 0.1379    \\
...
\begin{table}[b]
\setlength{\tabcolsep}{2.9pt}
\caption{SHAP values \textbf{(rescaled to add to $100$)} for base algorithms in each prediction step for observed features using $121$ spectroscopically confirmed AGN at high redshift values ($z > 4$).}             % title of Table
...
\begin{table}
\setlength{\tabcolsep}{2.9pt}
\caption{Combined and normalised \textbf{(rescaled to add to $100$)} mean absolute SHAP values for observed features from the three models using $121$ spectroscopically confirmed AGN at high redshift values ($z \geq 4$).}             % title of Table
