...
redshift_reg      = redshift_reg_full.named_steps['trained_model'].estimators_[0]
...
_ = gf.plot_shap_decision('Redshift prediction', 'rf', shap_values_z, explainer_z, 
                          reduced_cols, ax1, 'identity', new_base_value=0.0, 
                          base_meta='Base', xlim=xlims_plt, highlight=filter_radio)
plt.savefig(paths.figures / 'SHAP/SHAP_decision_z_base_rf_HETDEX_highz.pdf', bbox_inches='tight')
