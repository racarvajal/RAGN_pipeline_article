...
_ = gf.plot_shap_decision('Radio detection', 'et', shap_values_radio, explainer_radio, 
                          reduced_cols, ax1, 'identity', new_base_value=0.5, 
                          base_meta='Base')
plt.savefig(paths.figures / 'SHAP/SHAP_decision_radio_base_et_HETDEX_highz.pdf', bbox_inches='tight')
