...
AGN_gal_clf       = AGN_gal_full.named_steps['trained_model'].estimators_[3]
...
_ = gf.plot_shap_decision('AGN/Galaxy class', 'gbc', shap_values_AGN, explainer_AGN,\
                          reduced_cols, ax1, 'logit', new_base_value=base_logit_AGN, base_meta='Base')
plt.savefig(paths.figures / 'SHAP/SHAP_decision_AGN_base_gbc_HETDEX_highz.pdf', bbox_inches='tight')
