...
_ = gf.plot_shap_decision('AGN/Galaxy class', 'xgboost', shap_values_AGN, explainer_AGN,\
                          reduced_cols, ax1, 'logit', new_base_value=base_logit_AGN, base_meta='Base')
plt.savefig(paths.figures / 'SHAP/SHAP_decision_AGN_base_xgboost_HETDEX_highz.pdf', bbox_inches='tight')
