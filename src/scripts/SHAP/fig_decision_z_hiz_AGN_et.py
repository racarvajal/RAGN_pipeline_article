...
_ = gf.plot_shap_decision('Redshift prediction', 'et', shap_values_z, explainer_z, 
                          reduced_cols, ax1, 'identity', new_base_value=0.0, 
                          base_meta='Base', xlim=xlims_plt)
plt.savefig(paths.figures / 'SHAP/SHAP_decision_z_base_et_HETDEX_highz.pdf', bbox_inches='tight')
