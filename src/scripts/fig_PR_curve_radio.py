...
viz_train.plot(ax=ax1,       lw=3.5, c=cm.get_cmap(gv.cmap_bands)(0.0), alpha=0.75, label=f"Training    (AUC = {auc_pr_train_cal:.4f})")
viz_test.plot(ax=ax1,        lw=3.5, c=cm.get_cmap(gv.cmap_bands)(0.3), alpha=0.75, label=f"Test        (AUC = {auc_pr_test_cal:.4f})")
viz_train_test.plot(ax=ax1,  lw=3.5, c=cm.get_cmap(gv.cmap_bands)(0.5), alpha=0.75, label=f"Train+Test  (AUC = {auc_pr_train_test_cal:.4f})")
viz_calib.plot(ax=ax1,       lw=3.5, c=cm.get_cmap(gv.cmap_bands)(0.7), alpha=0.75, label=f"Calibration (AUC = {auc_pr_calib_cal:.4f})")
viz_val.plot(ax=ax1,         lw=3.5, c=cm.get_cmap(gv.cmap_bands)(0.9), alpha=0.75, label=f"Validation  (AUC = {auc_pr_validation_cal:.4f})")
...
ax1.plot([0, 1], [no_skill_test,       no_skill_test],       ls='--', marker=None, c=cm.get_cmap(gv.cmap_bands)(0.4), alpha=0.4, lw=3.5)
